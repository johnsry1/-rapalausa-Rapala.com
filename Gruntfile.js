...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        watch: {
            ...
            doc: {
                files: ['doc/js/**/*', '!doc/dist/', '!doc/.tmp', 'app_adapter/**/*.{js,ds}', 'app_adapter/**/*.{js,ds}'],
                tasks: ['jsdoc']
            },
            server: {
                files: [
                    'app_adapter/cartridge/**/*.{js,json,properties}',
                    'app_adapter/cartridge/**/*.{isml,json,properties,xml}',
                    'app_adapter/cartridge/scripts/**/*.{js,ds}',
                    'app_adapter/cartridge/static/**/*.{js,css,png,gif}',
                    'app_adapter/cartridge/**/*.{properties,xml}'
                ],
                tasks: ['dwDavUpload'],
                options: {
                    spawn: false
        ...
        jsdoc: {
            ...
            client: {
                src: ['app_adapter/cartridge/js/README.md', '.'],
                options: {
        ...
        dwDavUpload: {
            ...
            src: 'app_adapter/cartridge/controllers/Product.js'
        },
        concurrent: {
            options: {

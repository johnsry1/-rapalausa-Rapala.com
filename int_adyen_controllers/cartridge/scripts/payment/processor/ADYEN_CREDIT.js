...
function Handle(args) {
    ...
    var tokenID = AdyenHelper.getCardToken(creditCardForm.object.selectedCardID != null ? creditCardForm.get('selectedCardID').value() : '', customer);
...
function Authorize(args) {
    ...
    if (result.IssuerUrl != '') {
        ...
        session.privacy.paymentInstrument = paymentInstrument;
        return {
            authorized: true,
            authorized3d: true,
            view: app.getView({

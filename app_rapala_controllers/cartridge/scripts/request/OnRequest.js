...
/*	Site Context called for every request to identify current site user is browsing
	...
	if (request.httpPath.indexOf('rapala-') != -1 || request.httpPath.indexOf('rapalaEU') != -1 || request.httpPath.indexOf('UpdateCurrency') != -1 || request.httpPath.indexOf('SetLocale') != -1 || request.httpPath.indexOf('Default') != -1) {

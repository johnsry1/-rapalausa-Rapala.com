...
function controls() {
    ...
    //JIRA PREV-464 : Products added in the Compare section are removed from PLP along with many other products also. Replaced comparison with {'products':comparison.getProducts()}
    app.getView({CompareList: {'products': comparison.getProducts()}, Category: category.object}).render('search/components/productcomparewidget');
}

...
function leftNav() {
//	var CustomerServiceLinks = require('app_rapala_core/cartridge/scripts/customerservice/GetCustomerServiceContent.ds').execute("customer-service");
    app.getView({
    	
    	//CustomerServiceLinks : CustomerServiceLinks
    }).render('sitemap/libraryfolder');

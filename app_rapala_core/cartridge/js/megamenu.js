...
var megamenu = {
    ...
    open: function () {
        ...
        $('.menulist').find('.sub-cat-drop-down').attr('aria-haspopup', 'menu').attr('aria-expanded', 'false');
        $('.sub-category-section-1').attr('aria-expanded', 'false').hasClass('.js-active-sub-menu').removeClass('.js-active-sub-menu');
    },
    close: function () {
